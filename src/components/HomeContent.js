    ...
    >
      <Flex gap={100} bg="gray.700">
        <Image
          ...
          shadow="dark-lg"
        />
        <Box color="teal.200" maxW="sm" pt={5} bg="gray.700">
          <Text fontSize="32" bg="gray.700">Hey! 👋</Text>
          <Divider borderColor="gray.200" mt={2} mb={2} />
          <Box color="white" bg="gray.700">
            I am{' '}
            <Text as="span" fontWeight={700} color="teal.200" bg="gray.700">
              Debraj Kundu
            </Text>{' '}
            ...
            <Text as="span" color="teal.200" bg="gray.700">
              {' '}
              web development.
            </Text>
            <br />
      ...
      <Text color="teal.200" bg="gray.700">
        <Link to="/project" >
          Thanks for visiting! be sure to checkout my projects 😉{' '}
        </Link>
      </Text>
    </Box>
  )
